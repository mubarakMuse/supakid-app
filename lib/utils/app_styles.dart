...
class AppStyles {
  static TextStyle robotTextStyle(Color color,double fontSize, FontWeight fontWeight) => TextStyle(
      fontSize: fontSize.sp,
      fontWeight: fontWeight,
      color: color,
      fontFamily: 'Roboto');

  static TextStyle figTextStyle(Color color,double fontSize, FontWeight fontWeight) => TextStyle(
      fontSize: fontSize.sp,
      fontWeight: fontWeight,
      color: color,
      fontFamily: 'Fig');

  static TextStyle figBoldTextStyle(Color color,double fontSize, FontWeight fontWeight) => TextStyle(
      fontSize: fontSize.sp,
      fontWeight: fontWeight,
      color: color,
      fontFamily: 'FigBold');
